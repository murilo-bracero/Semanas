...
class DBProvider{
  ...
  createWeek(var days, var weekdays) async{
    ...
    String query = "INSERT INTO week(day, weekday) VALUES ('${days[0]}','${weekdays[0]}'),('${days[1]}','${weekdays[1]}'),"
  ...
  Future<List<String>> getDays() async{
    ...
    print(query);
    var res = await db.rawQuery(query);
    List<String> days = res.isNotEmpty ? res.map((c) => Notes.fromJson(c).day).toList() : [];
    return days;
  }
